<template>
  <div class="wrapper">
    ...
    <div style="width: 50%; margin: 100px auto;  background: #fff;border-radius:10px;display: flex">
      <!--  display:flex ：flex布局          -->
      <div style="flex: 1">
      ...
      <!--     注册表单-->
      <div style="flex: 100;padding: 30px">

        <div style="margin:10px auto 25px; text-align: center; font-size: 28px;"><b>注册</b></div>
...
<script>
  ...
  // import imgUrl from "../assets/imgs/register.png";
