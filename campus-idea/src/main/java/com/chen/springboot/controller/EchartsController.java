...
public class EchartsController {
    ...
    public Result get() {
        ...
        map.put("x", CollUtil.newArrayList("Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"));//集合 list数组
    ...
    public Result members() {
        ...
        int q1 = 0; // 第一季度          按照季度划分，每个季度有多少人
        int q2 = 0; // 第二季度
        int q3 = 0; // 第三季度
        int q4 = 0; // 第四季度
        for (User user : list) {
            Date createTime = user.getCreateTime();   //获取时间
...
//    @Cacheable(value = "files" ,key = "'frontAll'")  自定义的缓存名称frontAll
